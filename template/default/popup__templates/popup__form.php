<div class="overlay-bonus overlay overlay-<?=$name?>">
    ...
    <div class="popup__bonus  popup popup-<?=$name?>">
        <div class="popup__bonus-body">
            <form class="popup__form <?php if (isset($popup__do->form)) echo 'popup__application' ?>" method="POST" action="<?php if (isset($popup__do->form)) { echo '/ClientsController/application';}?>">
