        ...
        <div class=" UserContacts userPopup__body">
            <div class="UserContacts-body ">
                <div class="UserContacts-item UserContacts-body__telephone ">
                    ...
                    <input type="tel" placeholder="Введите номер телефона" maxlength="15">
                </div>
                <div class="UserContacts-item UserContacts-body__email">
                    <div class="UserContacts-body__header">
                        <img src="../img/UserContacts/email.svg" alt="">
                        <span>email:</span>
                    </div>
                    <input type="email" placeholder="Введите ваш email" maxlength="30">
                </div>
